...
def slugify(title):
    ...
    if title.lower() == "home":  # Ensure 'Home' becomes 'index.html'
        return "index.html"
    return re.sub(r'\W+', '-', title.strip().lower()) + ".html" #regular expression
...
#Create html funtion
def create_html_file(title, titles, output_dir="assignment_06"):
...
#Create css function
def create_css_file(output_dir="assignment_06"):
...
def main():
    ...
    titles = ["Home", "About Me", "Gallery", "Contact"]
